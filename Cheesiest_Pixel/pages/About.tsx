...
const About: React.FC<AboutProps> = ({ onLoginClick }) => {
  return (
      ...
      <section className="py-24 px-6 relative bg-slate-50 dark:bg-dark-bg border-t border-slate-200 dark:border-slate-800">
         <div className="max-w-7xl mx-auto">
             <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                 {[
                     { label: 'Patient Outcomes', value: <CountUp end={40} suffix="%" />, sub: 'Improvement in Chronic Care', icon: Activity },
                     { label: 'Research Data', value: <CountUp end={2.5} decimals={1} suffix="TB" />, sub: 'Structured Ayurvedic Knowledge', icon: Fingerprint },
                     { label: 'Global Reach', value: <CountUp end={120} suffix="+" />, sub: 'Partner Clinics Worldwide', icon: Globe },
                     { label: 'Cost Reduction', value: <CountUp end={60} suffix="%" />, sub: 'In Rural Deployments', icon: Scale },
                 ].map((stat, idx) => (
